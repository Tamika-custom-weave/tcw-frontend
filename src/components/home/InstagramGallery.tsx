...
const images = [
  ...
  "https://images.unsplash.com/photo-1616886295551-78cd20f78089?q=80&w=1780&auto=format&fit=crop",
  "https://images.unsplash.com/photo-1632765854612-9b02b6ec2b15?q=80&w=1886&auto=format&fit=crop",
  ...
  return (
    <section className="pt-24 bg-white">
      <div className="text-center mb-12">
        ...
        <Link href="#" className="text-gray-500 font-light hover:text-brand-gold transition-colors">
          @TamikaCustomWeave
        </Link>
      </div>
